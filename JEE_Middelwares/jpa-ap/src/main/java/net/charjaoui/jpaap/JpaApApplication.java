package net.charjaoui.jpaap;

import net.charjaoui.jpaap.entities.*;
...
import net.charjaoui.jpaap.services.HospitalServiceImpl;
import net.charjaoui.jpaap.services.UserServiceImpl;
...
public class JpaApApplication {
    ...
    public CommandLineRunner start(PatientRepository patientRepository,
        ...
        return args -> {
            ...
            Stream.of("Cecile", "Albert", "Rida", "Alexandre", "Mariam").forEach(name -> {
            ...
            Stream.of("John", "Mark", "Ahmed", "Sami").forEach(name -> {
            ...
            try {
                ...
                System.out.println("User has has not been authenticated!");
                e.printStackTrace();
            }
        };
    }
